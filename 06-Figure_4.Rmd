---
title: "Figure 4 In Vitro Analysis"
...
#colors<-c(cbPalette[8],cbPalette[6],rep("darkgray",4),rep("darkgreen",4),rep("#549EC9",4))
...
svglite::svglite(paste0("vitro_Plppr4_expression_wKO_",ts,".svg"),width=5,height=7)
