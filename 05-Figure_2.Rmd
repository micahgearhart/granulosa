...
sample_size<-79
length(d<-sample(vivo_atac_subset[vivo_atac_subset$class=="Constitutive" & vivo_atac_subset$postnatal_Female_na > 3.3 & vivo_atac_subset$postnatal_Male_na > 3.3],sample_size))
...
mat_a_pwm=normalizeToMatrix(group_a_sites, temp, value_column = "score", mean_mode = "absolute",
         extend = width, w = 50, smooth = FALSE)
#mat_klf4_pwm=normalizeToMatrix(klf4_pwm, temp, value_column = "score", mean_mode = "absolute",
#         extend = width, w = 50, smooth = FALSE)
mat_b_pwm=normalizeToMatrix(group_b_sites, temp, value_column = "score", mean_mode = "absolute",
         extend = width, w = 50, smooth = FALSE)
