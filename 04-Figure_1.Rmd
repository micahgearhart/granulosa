...
## Create a DDS object of the whole gonad samples ****MOVE TO FIGURE 2 & Delte PCA
```{r }
...
## Use meme to identify motifs under Dmrt1, Foxl2 and Sox9 ChIP peaks   ****MOVE TO FIGURE 2
```{r}
length(ovary_foxl2)
length(testis_sox9)
...
#Import Meme on ChIPs  ****MOVE TO FIGURE 2
```{r}
...
## what motif is under Sertoli DARs without Dmrt1/Sox9 motifs  ****MOVE TO FIGURE 2
```{r}
...
# Heatmap of ChIP and ATAC Peaks and Motifs  ****Move to FIGURE 3
