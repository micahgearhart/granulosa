...
write.csv(tibble::rownames_to_column(temp,var="Ensembl GeneID"),"Lindeman_et_al_RNAseq_counts.csv",quote=F,row.names=F)
getwd()
...
#(peak_p23_atac_XX_files <- list.files("../data","gappedPeak$",full.names=T) %>% str_subset("112315",negate=F) %>% str_subset("gran"))
#lengths(peak_p23_atac_XX<-GRangesList(lapply(peak_p23_atac_XX_files,narrowPeakToGRanges)))
#length(peak_p23_atac_XX<-reduce(unlist(peak_p23_atac_XX)))
#length(peak_p23_atac_XX<-peak_p23_atac_XX[!peak_p23_atac_XX %over% el_mm10])


#(peak_p7_atac_XY_files <- list.files("../data","gappedPeak$",full.names=T) %>% str_subset("gran",negate=T) %>% str_subset("GW052319",negate=T) )
#lengths(peak_p7_atac_XY<-GRangesList(lapply(peak_p7_atac_XY_files,narrowPeakToGRanges)))
#length(peak_p7_atac_XY<-reduce(unlist(peak_p7_atac_XY)))
#length(peak_p7_atac_XY<-peak_p7_atac_XY[!peak_p7_atac_XY %over% el_mm10])



#Open regions in Granulosa Cells
#length(peak_p23_atac_XX_rep1<-gappedPeakToGRanges("../data/gran-1-112315_S1.hmmr_peaks.gappedPeak"))
#length(peak_p23_atac_XX_rep2<-gappedPeakToGRanges("../data/gran-2-112315_S1.hmmr_peaks.gappedPeak"))
#length(peak_p23_atac_XX_rep3<-gappedPeakToGRanges("../data/gran-1-102120_S1.hmmr_peaks.gappedPeak"))
#length(peak_p23_atac_XX_rep4<-gappedPeakToGRanges("../data/gran-2-102120_S1.hmmr_peaks.gappedPeak"))
#length(peak_p23_atac_XX_rep5<-gappedPeakToGRanges("../data/gran-3-102120_S1.hmmr_peaks.gappedPeak"))
...
length(peak_p23_atac_XX_rep3<-broadPeakToGRanges("../data/gran-1-102120_S1.noMT.dedup.unique.macs_peaks.broadPeak"))
length(peak_p23_atac_XX_rep4<-broadPeakToGRanges("../data/gran-2-102120_S1.noMT.dedup.unique.macs_peaks.broadPeak"))
length(peak_p23_atac_XX_rep5<-broadPeakToGRanges("../data/gran-3-102120_S1.noMT.dedup.unique.macs_peaks.broadPeak"))
length(peak_p23_atac_XX <- reduce(c(peak_p23_atac_XX_rep1,peak_p23_atac_XX_rep2,peak_p23_atac_XX_rep3,peak_p23_atac_XX_rep4,peak_p23_atac_XX_rep5)))
length(peak_p23_atac_XX<-peak_p23_atac_XX[peak_p23_atac_XX %over% peak_p23_atac_XX_rep1 & 
                                               ...
                                               peak_p23_atac_XX %over% peak_p23_atac_XX_rep4 &
                                               peak_p23_atac_XX %over% peak_p23_atac_XX_rep5 &
                                               !peak_p23_atac_XX %over% el_mm10])

#Open regions in Sertoli Cells
#length(peak_p7_atac_XY_rep1<-gappedPeakToGRanges("../data/sertoli-101415_S1.hmmr_peaks.gappedPeak"))
#length(peak_p7_atac_XY_rep2<-gappedPeakToGRanges("../data/Serolti-112315_S1.hmmr_peaks.gappedPeak"))
#length(peak_p7_atac_XY_rep3<-gappedPeakToGRanges("../data/sertoli_fresh_ATAC_rep1_N704_GW052319.hmmr_peaks.gappedPeak"))
#length(peak_p7_atac_XY_rep4<-gappedPeakToGRanges("../data/sertoli_fresh_ATAC_rep2_N705_GW052319.hmmr_peaks.gappedPeak"))
#length(peak_p7_atac_XY_rep5<-gappedPeakToGRanges("../data/sertoli_fresh_ATAC_rep3_N706_GW052319.hmmr_peaks.gappedPeak"))
...
length(peak_p7_atac_XY_rep3<-broadPeakToGRanges("../data/sertoli_fresh_ATAC_rep1_N704_GW052319.noMT.dedup.unique.macs_peaks.broadPeak"))
length(peak_p7_atac_XY_rep4<-broadPeakToGRanges("../data/sertoli_fresh_ATAC_rep2_N705_GW052319.noMT.dedup.unique.macs_peaks.broadPeak"))
length(peak_p7_atac_XY_rep5<-broadPeakToGRanges("../data/sertoli_fresh_ATAC_rep3_N706_GW052319.noMT.dedup.unique.macs_peaks.broadPeak"))
length(peak_p7_atac_XY <- reduce(c(peak_p7_atac_XY_rep1,peak_p7_atac_XY_rep2,peak_p7_atac_XY_rep3,peak_p7_atac_XY_rep4,peak_p7_atac_XY_rep5)))
length(peak_p7_atac_XY<-peak_p7_atac_XY[peak_p7_atac_XY %over% peak_p7_atac_XY_rep1 & 
                                               ...
                                               peak_p7_atac_XY %over% peak_p7_atac_XY_rep4 &
                                               peak_p7_atac_XY %over% peak_p7_atac_XY_rep5 &
...
rtracklayer::export(peak_p23_atac_XX_rep3,paste0("peak_p23_atac_XX_rep3",ts,".bed"))
rtracklayer::export(peak_p23_atac_XX_rep4,paste0("peak_p23_atac_XX_rep4",ts,".bed"))
rtracklayer::export(peak_p23_atac_XX_rep5,paste0("peak_p23_atac_XX_rep5",ts,".bed"))
...
rtracklayer::export(peak_p7_atac_XY_rep3,paste0("peak_p7_atac_XY_rep3",ts,".bed"))
rtracklayer::export(peak_p7_atac_XY_rep4,paste0("peak_p7_atac_XY_rep4",ts,".bed"))
rtracklayer::export(peak_p7_atac_XY_rep5,paste0("peak_p7_atac_XY_rep5",ts,".bed"))
...
```{r load_ChIP_ATAC_peaklist,eval=T}
#ChIP Peak lists
length(sertoli_dmrt1_rep1<-narrowPeakToGRanges("../data/covaris_6c_sertoli_dmrt1ChIP.R1.fastq.dedup.unique.macs_peaks.narrowPeak"))
length(sertoli_dmrt1_rep2<-narrowPeakToGRanges("../data/DM1.dedup.unique.macs_peaks.narrowPeak"))
length(sertoli_dmrt1 <- reduce(c(sertoli_dmrt1_rep1,sertoli_dmrt1_rep2)))
length(sertoli_dmrt1<-sertoli_dmrt1[sertoli_dmrt1 %over% sertoli_dmrt1_rep1 &
                                    sertoli_dmrt1 %over% sertoli_dmrt1_rep1 &
                                      !sertoli_dmrt1 %over% el_mm10])

length(sertoli_sox9_rep1<-narrowPeakToGRanges("../data/Sox91.dedup.unique.macs_peaks.narrowPeak"))
length(sertoli_sox9_rep2<-narrowPeakToGRanges("../data/Sox92.dedup.unique.macs_peaks.narrowPeak"))
length(sertoli_sox9 <- reduce(c(sertoli_sox9_rep1,sertoli_sox9_rep2)))
length(sertoli_sox9<-sertoli_sox9[sertoli_sox9 %over% sertoli_sox9_rep1 &
                                    sertoli_sox9 %over% sertoli_sox9_rep1 &
...
length(testis_sox9<-narrowPeakToGRanges(url("https://s3.msi.umn.edu/zarkowe0/sox9_testis_idx512.dedup.unique.noMT.macs_peaks.narrowPeak")))
